        ...
        <CarouselItem key={slide.id}>
          ...
          <div className="relative w-full h-[650px] md:h-[800px] flex flex-col items-center justify-center py-10 md:py-20 px-4 md:px-6 overflow-hidden">
            ...
            >
              ...
              <motion.div variants={heroItemVariants} className="mb-6 md:mb-16">
              ...
              >
                <Button
                  size="lg"
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 md:px-12 h-12 md:h-16 text-sm md:text-lg font-bold rounded-full w-full sm:w-auto"
                >
                  {slide.cta}
                </Button>
                <Button
