  ...
  return (
    <div className="min-h-screen bg-white pb-24">
      <div className="max-w-7xl mx-auto px-4 pt-28">
        ...
        {/* Navigation */}
        <Button variant="link" onClick={() => router.push("/products/accessories")} className="mb-8 p-0 text-blue-900 hover:no-underline font-semibold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-6">
            <div className="lg:sticky lg:top-32 space-y-6">
              <div className="relative w-full h-[350px] md:h-[480px] bg-slate-50 rounded-2xl border border-slate-100 overflow-hidden shadow-sm">
                <Image
              ...
              <div className="flex gap-3 overflow-x-auto pb-2 no-scrollbar justify-center">
                {accessoryImages.map((img, idx) => (
                  <button
                    ...
                    className={`relative w-20 h-20 flex-shrink-0 rounded-xl border-2 transition-all bg-white ${
              ...
              <Button 
                ...
                className="w-full h-16 rounded-xl bg-blue-900 hover:bg-blue-800 text-white font-bold text-lg shadow-xl shadow-blue-50 transition-all active:scale-95"
              >
               Fill Inquire From
              </Button>
            </div>
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl border border-slate-100 bg-slate-50 flex items-center gap-4">
                <div className="bg-white p-2.5 rounded-lg text-blue-900 shadow-sm"><ShieldCheck size={22}/></div>
                <div>
                  <h4 className="text-sm font-bold text-slate-900">Warranty</h4>
                  <p className="text-[11px] text-slate-500 font-medium tracking-tight">Standard Support</p>
                </div>
              </div>
              <div className="p-4 rounded-xl border border-slate-100 bg-slate-50 flex items-center gap-4">
                <div className="bg-white p-2.5 rounded-lg text-blue-900 shadow-sm"><Truck size={22}/></div>
                <div>
                  <h4 className="text-sm font-bold text-slate-900">Fast Shipping</h4>
                  <p className="text-[11px] text-slate-500 font-medium tracking-tight">Safe Delivery</p>
                </div>
              </div>
            ...
            {accessory.specifications && accessory.specifications.length > 0 && (
              <div className="pt-2 space-y-4">
                <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                  <Award size={20} className="text-blue-900" /> Key Features
                </h3>
                <div className="space-y-3">
                  {accessory.specifications.map((spec: any, i: number) => (
                    <div key={i} className="flex items-start gap-3 p-2 rounded-xl hover:bg-slate-50 transition-all">
                      <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm text-slate-700 leading-relaxed font-medium">{spec.points}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* DESCRIPTION & INQUIRY (Now at the Bottom) */}
            ...
            <div className="space-y-4 mt-2">
              <div className="flex items-center gap-4 bg-blue-50 p-3 rounded-2xl border border-blue-100">
                ...
                <div>
                  ...
                  <h4 className="font-bold text-blue-900 leading-tight">{accessory.productTitle}</h4>
                </div>
              </div>
